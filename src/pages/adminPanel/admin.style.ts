...
export const AdminPageBody = styled.img`
    background: cover;
    width: 100%;
    height: 120%;
    z-index: -1;
...
export const AdminPageTxt = styled(Container)`
    z-index: 20;
    position: relative;
...
`
export const AdminPageHeading = styled.div`
    display: flex;
    justify-content: center;
    margin-top: 40px;
    padding: 0px 15px 0px 15px;
`
export const AdminPageP = styled.div`
    color: #876445;
    font-size: 20px;
    text-align: justify;
